    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            foreach ($arr as $item) { //foreach element in $arr
                ...
                if ($etat) {
                    $html2 = $html2 . "<td><p>$PlancheNom</p><a href='http://planches.techsysprogram.fr/LotoWS/PDFRecuperer/PL-$Codebarre.pdf' target='_blank'> <button class='btn btn-success' vertical-align:bottom>$Codebarre</button> </a></td>";
                } else {
                    $html2 = $html2 . "<td><p>$PlancheNom</p><p>$Codebarre</p></td>";
                }
                $html2 = $html2 . "<td><a href='http://planches.techsysprogram.fr/LotoWS/PDFRecuperer/PL-$Codebarre.pdf' target='_blank'> <button class='btn btn-danger' vertical-align:bottom><i class='bi-x'></i> </button> </a></td>";
